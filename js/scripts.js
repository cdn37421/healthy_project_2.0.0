                  ...
                  if (!(k instanceof _)) {
                    ...
                    if (S) {
                      ...
                      if (
                        ...
                        1 != O &&
                          C.matchGrammar(e, r, n, y, v, !0, l + "," + u),
                        i)
                      )
                        break;
                    } else if (i) break;
            ...
            u.addEventListener(
              ...
              function (e) {
                var r = JSON.parse(e.data),
                  ...
                  t = r.code,
                  a = r.immediateClose;
                u.postMessage(C.highlight(t, C.languages[n], n)),
                  a && u.close();
              },
              !1
            )),
...
!(function (n) {
  ...
  n.languages.json5 = n.languages.extend("json", {
    ...
    string: { pattern: e, greedy: !0 },
    number:
      /[+-]?(?:NaN|Infinity|0x[a-fA-F\d]+|(?:\d+\.?\d*|\.\d+)(?:[eE][+-]?\d+)?)/,
  });
})(Prism);
!(function (a) {
  var e = "(?:\\b[a-zA-Z]\\w*|[|\\\\[\\]])+";
...
"undefined" != typeof self &&
  ...
  Prism.hooks.add("before-sanity-check", function (t) {
    if (
      (t.element.matches || t.element.msMatchesSelector).call(
        t.element,
      ...
      return (
        ((a = document.createElement("pre")).className = e.className =
          t.element.className),
        t.element.dataset &&
          Object.keys(t.element.dataset).forEach(function (e) {
            Object.prototype.hasOwnProperty.call(t.element.dataset, e) &&
              (a.dataset[e] = t.element.dataset[e]);
          }),
        (t.code = t.code.replace(/&lt;\/script(>|&gt;)/gi, "</script>")),
        (e.textContent = t.code),
        a.appendChild(e),
        t.element.parentNode.replaceChild(a, t.element),
        void (t.element = e)
      );
    }
    ...
    !t.code &&
      ...
      t.element.childNodes.length &&
      "#comment" == t.element.childNodes[0].nodeName &&
      (t.element.textContent = t.code = t.element.childNodes[0].textContent);
  }));
!(function () {
  var i =
    Object.assign ||
